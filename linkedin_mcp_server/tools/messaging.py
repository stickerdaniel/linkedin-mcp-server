...
def register_messaging_tools(mcp: FastMCP) -> None:
    ...
    async def get_inbox(
        ...
        Returns:
            ...
            The LLM should parse the raw text to extract conversations.
        """
        try:
    ...
    async def get_conversation(
        ...
        Returns:
            ...
            The LLM should parse the raw text to extract messages.
        """
        try:
            logger.info(
    ...
    async def send_message(
        ...
        The recipient must be a 1st-degree connection. This is a write operation
        that sends a real message on LinkedIn.

        Args:
            linkedin_username: LinkedIn username of the recipient (e.g., "williamhgates")
            message: The message text to send
            ctx: FastMCP context for progress reporting

        Returns:
            Dict with url and sections (confirmation -> sent message text).
        """
        try:
