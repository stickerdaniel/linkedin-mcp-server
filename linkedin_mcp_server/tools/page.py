"""LinkedIn page scraping tool for public routes outside person/company/job tools."""
...
from linkedin_mcp_server.dependencies import get_linkedin_page_extractor
...
_LINKEDIN_PAGE_EXTRACTOR = Depends(get_linkedin_page_extractor)
...
def register_page_tools(mcp: FastMCP) -> None:
    ...
    async def get_linkedin_page(
        linkedin_url: str,
        ctx: Context,
        extractor: Any = _LINKEDIN_PAGE_EXTRACTOR,
    ) -> dict[str, Any]:
        """
