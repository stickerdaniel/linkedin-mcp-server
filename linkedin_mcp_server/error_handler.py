...
def raise_tool_error(exception: Exception) -> NoReturn:
    """
    ...
    if isinstance(exception, CredentialsNotFoundError):
        ...
        logger.warning("LinkedIn error: %s", exception)
