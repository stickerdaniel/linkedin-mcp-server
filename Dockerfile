# Force x86_64 for Chrome real (not available on ARM64 Linux)
FROM --platform=linux/amd64 python:3.14-slim-bookworm@sha256:55e465cb7e50cd1d7217fcb5386aa87d0356ca2cd790872142ef68d9ef6812b4
...
# Install dependencies, system libs for Chrome, and patched Chrome binary
RUN uv sync --frozen && \
