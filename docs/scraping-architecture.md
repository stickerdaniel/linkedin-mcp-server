...
| `job_pages` | `APPLY_READY_JS`, `APPLY_SIGNALS_JS`, `DIALOG_REDIRECT_JS`, `EXTERNAL_APPLY_MARK`, `JOB_IDS_JS`, `JobApplyRead`, `JobPageCapture`, `JobPageReader`, `MARK_EXTERNAL_APPLY_JS`, `PROMOTED_JOB_IDS_JS` | `page-owning` |
