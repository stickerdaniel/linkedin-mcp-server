...
class TestContactExtraction:
    ...
    def test_contact_info_field_types(self):
        ...
        with mock.patch("linkedin_scraper.Person.__init__"):
            ...
            assert contact["connected_date"] is None or isinstance(
                contact["connected_date"], str
            )
            assert contact["linkedin_url"] is None or isinstance(
                contact["linkedin_url"], str
            )
